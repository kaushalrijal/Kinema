...
export default function Hero(props) {
  return (
    <section className={`relative  bg-cover bg-center bg-no-repeat w-screen font-medium lg:h-full pb-0 items-center`} style={{ backgroundImage: `url(${bg.src})`}}>
      ...
      <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-fit lg:items-center lg:px-8 ">
        <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
          ...
          <div className="mt-8 lg:flex md:flex gap-4 text-center justify-center gap:3">
            <input
              type="search"
              className="block w-full rounded bg-[#1100b3] px-12 py-3 my-3 lg:my-0 text-sm font-medium text-white shadow focus:outline-none focus:ring sm:w-auto"
